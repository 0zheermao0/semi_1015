...
def parse_args():
    ...
    parser.add_argument('--gnn_type', default='gcn', type=str, choices=['gcn', 'ppmi', 'cached_gcn'], help='Type of GNN layer for experts')
    parser.add_argument('--num_hops', default=1, type=int, help='Number of hops/layers for expert GNN propagation')
    ...
    parser.add_argument('--expert_num', default=3, type=int, help='number of experts')
